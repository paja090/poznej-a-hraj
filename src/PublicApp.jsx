...
<div
  ...
  style={{
    right: "12px",           // světlo posunuto doleva
    top: "54%",              // světlo posunuto výš
...
>
  ...
  <div
    className="absolute"
    style={{
      bottom: "18px",        // KUŽEL NAHORU → světlo vychází nahoru
      left: "-12px",
      width: "45px",
      height: "90px",
      background: "linear-gradient(to top, rgba(255,244,160,0.85), rgba(255,244,160,0) 90%)",
      filter: "blur(10px)",
      opacity: 0.9,
      pointerEvents: "none",
    }}
