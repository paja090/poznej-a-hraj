  ...
  <div className="max-w-7xl w-full mx-auto flex items-center justify-between px-4 py-3">
    ...
    <div className="flex items-center gap-2 md:gap-4">
      <img 
        src="/rebuss.png"
        alt="Reboos Logo"
        className="h-12 w-auto md:h-28 object-contain transition-transform duration-300 hover:scale-105"
      />
...
<section id="for-who" className="mt-16 space-y-6">
  ...
  Vyber si večer, který ti sedne. Každá akce má své tempo, atmosféru a originální program.
          ...
          <div>
            ...
            <p className="mb-6 text-white/70 text-sm">
  Takto to u nás vypadá. Reálné večery, reální lidé, skutečné zážitky.
</p>
            <div className="grid gap-6 lg:grid-cols-2">
              {past.length ? (
                past.map((e) => (
...
<p className="text-sm text-white/70">
  Lidé, kteří stojí za programem večera a starají se o to, aby sis odnesl skvělý zážitek.
</p>
          {loadingCrew ? (
        ...
        <section id="reviews" className="mt-16 space-y-6">
          ...
          <p className="text-sm text-white/70">
  Co říkají lidé, kteří už dorazili? Tohle je jejich skutečná zkušenost.
</p>
          {reviews.length === 0 ? (
