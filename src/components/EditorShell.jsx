          ...
          <div className="flex-1 overflow-y-auto p-5 text-sm text-slate-300">
            ...
            <div className="flex-1 overflow-y-auto p-5 text-sm text-slate-300 space-y-4">
              ...
              <ul className="list-disc list-inside space-y-1 text-xs md:text-sm">
                <li><strong>EditableBlock</strong> komponenta s ikonou ⚙️</li>
                <li><strong>EditorContext</strong> pro aktivní blok</li>
                <li>První editor – <code>EditorHero.jsx</code></li>
                <li>Autouložení do Firestore + historie změn</li>
              </ul>

              <p className="mt-4 text-xs text-slate-500">
                Ověř, že #/editor funguje a vidíš dvoupanelový layout.
              </p>
            </div>
          </aside>
        </main>
